    ...
    case 2:
      return (
        <div
          ...
          <select {...register("goal")} className=' outline-1 p-3 !outline-white bg-transparent rounded-xl w-[50%] h-12'>
      ...
      return (
        <div
          ...
          <div>
            ...
            <div className='mt-3 !border-solid !border-white border-[3px] w-[70%] rounded-xl'>
              <select {...register("gender")} className='bg-transparent w-full h-12 outline-none'>
          ...
          <div>
            ...
            <div className='mt-3 p-1 pr-4 !border-solid !border-white border-[3px] w-[70%] rounded-xl'>
              <textarea
                className='m-2 w-full h-full outline-none bg-transparent'
