  ...
  return (
    <div className='w-full max-h-full'>
      <Swiper 
        ...
        onSlideChange={(swiper) => setCurrentProfileIndex(swiper.realIndex)}
      >
        {demographicData.map(
          ({
            id,
              ...
              <div className='h-full flex flex-col items-center text-center justify-center'>
                ...
                <div className='grid grid-cols-4 gap-2 w-full'>
                  ...
                  <div className='flex flex-col gap-1'>
                    ...
                    <DemoSliderButton text='Market Fit' onClick={() => handleButtonClick(responseData.goodFitForMarket[index])} data={responseData.goodFitForMarket[index]} />
                    <DemoSliderButton text='Likes' onClick={() => handleButtonClick(responseData.whatUsersLike[index])} data={responseData.whatUsersLike[index]} />
                    <DemoSliderButton text='Pain Points' onClick={() => handleButtonClick(responseData.painPoints[index])} data={responseData.painPoints[index]} />
                    <DemoSliderButton text='Willingness to Pay' onClick={() => handleButtonClick(responseData.willingnessToPay[index])} data={responseData.willingnessToPay[index]} />
                  </div>
                  <div className='flex flex-col gap-1'>
                    ...
                    <DemoSliderButton text='Adoption Barrier' onClick={() => handleButtonClick(responseData.barrierForAdoption[index])} data={responseData.barrierForAdoption[index]} />
                    <DemoSliderButton text='Improvements' onClick={() => handleButtonClick(responseData.suggestedImprovements[index])} data={responseData.suggestedImprovements[index]} />
                    <DemoSliderButton text='Additional Feedback' onClick={() => handleButtonClick(responseData.additionalFeedback[index])} data={responseData.additionalFeedback[index]} />
                  </div>
                </div>
              </div>
            </SwiperSlide>
